...
해결방법:
S3로 로그를 배치 저장 후 EventBridge를 통한 이벤트 기반 처리로 변경
...
OpenSearch의 Fine-grained access control에서 bulk 작업 권한 명시적 허용
...
Slack의 분당 API 호출 제한(Tier 1: 1+ per minute) 초과
